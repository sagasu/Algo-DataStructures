    ...
    public void Test()
    {
        ...
        var hands = lines
            ...
            .Select(hand => new Hand(
                ...
                : hand.groups.FirstOrDefault(g => g.Count() is 3) is { } larger &&
                  hand.groups.Any(g => g.First() != larger.First() && g.Count() is 2) ? 5
                : hand.groups.Any(g => g.Count() is 3) ? 4
                : hand.groups.FirstOrDefault(g => g.Count() is 2) is { } firstPair &&
                  hand.groups.Any(g => g.First() != firstPair.First() && g.Count() is 2) ? 3
