...
public class Day19
{
    ...
    class Workflow
        ...
        class Rule
        {
            ...
            public bool IsAccepted => IsSpecialRule && Name == "A"; 
            public bool IsRejected => IsSpecialRule && Name == "R";
        ...
        {
            public string Name { get; set; }
            public int ExtremelyGoodLooking { get; set; } 
            public int Musical { get; set; } 
            public int Aerodynamic { get; set; }
