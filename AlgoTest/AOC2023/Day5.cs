...
public class Day5
{
    ...
    private List<Int128> _seeds = new List<Int128>();
    ...
    public void Test1()
    {
        ...
        Console.WriteLine(seeds2.Min().ToString());
    } 
    ...
    public void Test2()
    {
        ...
        Console.WriteLine(_ranges.MinBy(x => x.Start).Start.ToString());
    } 
